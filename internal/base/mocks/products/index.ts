...
export const successGetListProductHandler = [
...
export const loadingGetListProductHandler = [
  http.get(`${baseApiUrl}/products`, async () => {
    await delay(10000)
    return new HttpResponse("Timeout", {
      status: 500,
    })
  }),
]

export const errorGetListProductHandler = [
  http.get(`${baseApiUrl}/products`, () => {
...
export const successGetDetailProductHandler = [
  http.get(`${baseApiUrl}/products/:id`, () => {
    const response = {
      id: 1,
      title: "Essence Mascara Lash Princess",
      description:
...
export const errorGetDetailProductHandler = [
  http.get(`${baseApiUrl}/products/:id`, () => {
...
export const loadingGetDetailProductHandler = [
  http.get(`${baseApiUrl}/products/:id`, async () => {
    await delay(10000)
    return new HttpResponse("Timeout", {
      status: 500,
    })
